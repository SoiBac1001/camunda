...
//    createDefaultUser(engine);
    ...
    @Bean
    public ProcessEngineConfigurationImpl reconfigProcessEngine(List<ProcessEnginePlugin> camundaPlugins) {
        ...
        configuration.getProcessEnginePlugins().add(new CompositeProcessEnginePlugin(camundaPlugins));
